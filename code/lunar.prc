...
[[CCCB *ret 75 *v] [cb_callback : *callback] [*callback control 93 *v] [add *ret "Decay = " *v]]
[[CCCB *ret 76 *v] [cb_callback : *callback] [*callback control 94 *v] [add *ret "Sustain = " *v]]
...
[[CCCB *ret 71 *v] [cb_callback : *callback] [*callback control 82 *v] [add *ret "Resonance = " *v]]
[[CCCB *ret 77 *v] [cb_callback : *callback] [*callback control 91 *v] [- *v 64 *vv] [add *ret "Dry/Wet = " *vv]]
[[CCCB *ret 5 *v] [cb_callback : *callback] [*callback control 11 *v] [add *ret "Porta = " *v]]
[[CCCB *ret 78 *v] [cb_callback : *callback] [*callback control 95 *v] [- *v 64 *vv] [add *ret "Speed = " *vv]]
[[CCCB *ret 79 *v] [cb_callback : *callback] [*callback control 71 *v] [add *ret "Vibrato = " *v]]
