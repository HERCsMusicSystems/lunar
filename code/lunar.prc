...
program lunar #machine := "prolog.lunar"
			[
				...
				trigger inactive_trigger mixer stereo_mixer gateway stereo_gateway amplifier stereo_amplifier volume mono_volume lfo adsr eg egscaling egscal
...
[[InsertIO *parameters *op *selector [["ALGO" "TRIGGER" "FREQ1" "AMP1" "RATIO1" "FEEDBACK1" "FREQ2" "AMP2" "RATIO2" "FEEDBACK2" "FREQ3" "AMP3" "RATIO3" "FEEDBACK3" "FREQ4" "AMP4" "RATIO4" "FEEDBACK4"] ["SIGNAL"]]]
	...
	[AddParameterBlock *parameters amp "amp3" *op *selector3 -16383.0 "amp"]
	...
	[AddParameterBlock *parameters amp "amp4" *op *selector4 -16383.0 "amp"]
