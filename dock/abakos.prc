...
[[BuildAbakos *polyphony *Abakos *AbakosCB *volume]
	...
	[lfo *lfo]
	[volume *volume] [drywet *drywet] [delay *delay] [stereo_gateway *dry] [stereo_pan *pan] [stereo_chorus *chorus]
	...
	; INVISIBLE....
	[InsertController 11 *Abakos core delay gateway]
	...
	[Lunar 512 *Abakos core sens pitch]
	[Lunar 256 *Abakos core sens vibrato]
...
[[BuildAbakosPart *Abakos *cb *mixer *key_map *lfo *pitchfreq]
	...
	[adsr *adsr] [eg *adsr2]
	[*adsr "trigger" *trigger "trigger"] [*trigger "busy" *adsr "busy"] [*lfo "trigger" *adsr "busy"]
