...
[[BuildAstronaut *astronaut *astronautcb *line *span]
  ...
  [*chorus "left" *left_filter] [*chorus "right" *right_filter]
  [*left_filter "enter" *span "left"] [*right_filter "enter" *span "right"]
  [*left_filter "freq" *lfo "wahwah"] [*right_filter "freq" *lfo "wahwah"]
  ...
  [Insert *left_filter *astronaut filter]
  [Insert *right_filter *astronaut filter]
  [Insert *lfo *astronaut lfo]
  [InsertFor *astronaut lfo wahwah]
  ...
  ; 46 <=> 57
  [InsertController 71 *astronaut filter resonance]
  [InsertController 74 -64 *astronaut filter freq]
  [InsertController 75 -127 *astronaut filter amp]
  [InsertController 80 -64 *astronaut lfo speed]
  [InsertController 81 *astronaut lfo wave]
  [InsertController 82 -64 *astronaut lfo pulse]
  [InsertController 83 *astronaut lfo phase]
  [InsertController 84 *astronaut lfo wahwah]
]
