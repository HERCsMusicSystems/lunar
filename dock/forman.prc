...
[[BuildForman *polyphony *Forman *formancb *volume]
	...
	[parameter_block *modulation "index"] [gateway *vibrato] [*vibrato *modulation] [*lfo1 "vibrato" *vibrato]
	...
	[REPEAT *polyphony [BuildFormanPart *Forman *formancb *chorus *XData *YData *pitchvco *pitchfilter *lfo1 *lfo2]]
...
[[BuildFormanPart *Forman *cb *line *XData *YData *pitchvco *pitchfilter *lfo1 *lfo2]
