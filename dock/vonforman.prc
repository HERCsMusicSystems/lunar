...
[[BuildFilterBlock *order *X *Y *lfo1x *lfo1y *lfo2x *lfo2y *fm *noise *adsr *lfo1 *lfo2 *velocity *line [[*filter *freq *reso *q *fmsend *noisesend] : *filters]] [< 0 *order]
...
[[InsertFilterBlock *VF *index [[*filter *freq *reso *q *fmsend *noisesend] : *filters]]
